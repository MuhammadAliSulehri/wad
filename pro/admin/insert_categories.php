...
<head>
    ...
    if(isset($_POST['insert_button'])) {
        ...
        $ctg_title = $_POST['cat_title'];

        $insert_query = "insert into categories (cat_title) values ('$ctg_title')";
        echo $insert_query;
    ...
    <form  action="insert_categories.php" method="post">
        <div class="row">
            <div class="d-none d-sm-block col-sm-3 col-md-4 col-lg-2 col-xl-4 mt-auto">
                <label for="cat_title" class="float-md-right"> <span class="d-sm-none d-md-inline"> Category Title: </label>
            </div>
